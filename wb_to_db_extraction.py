...
def extract_all_pages():
    ...
    for i in range(1, 101):
        url = 'https://search.wb.ru/exactmatch/ru/male/v7/search?ab_testing=false&appType=1&curr=rub&dest=-535680&page=' + str(i) + '&query=%D0%B1%D1%80%D1%8E%D0%BA%D0%B8%20%D0%BC%D1%83%D0%B6%D1%81%D0%BA%D0%B8%D0%B5&resultset=catalog&sort=popular&spp=30&suppressSpellcheck=false&uclusters=0'
        headers = {
...
def main_task():
    ...
    extracted_pages = extract_all_pages()
...
if __name__ == '__main__':
    ...
    schedule.every(8).minutes.do(main_task)
    while True:
